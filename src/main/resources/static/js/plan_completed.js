$(function() {
    ...
    $("#input_search_submit").click(function() {
    	window.location.href = "/plan/findCompleted?search=" + $("#input_search").val();
    });
        ...
        $("#input_change_for_remove_submit").click(function() {
            if (id > 0) {
            	$.post("/plan/changeStatusForRemoveByIds", {
                    ...
                    window.location.href = "/plan/findCompleted?search=" + $("#input_search").val() + "&currentPage=" + $("#a_current_page").text();
                });
            }
        });
